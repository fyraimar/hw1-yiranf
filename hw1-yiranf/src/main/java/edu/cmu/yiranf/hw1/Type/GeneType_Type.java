...
public class GeneType_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.yiranf.hw1.Type.GeneType");
  ...
  public String getToken(int addr) {
      ...
      jcas.throwFeatMissing("token", "edu.cmu.yiranf.hw1.Type.GeneType");
  ...
  public int getSt(int addr) {
      ...
      jcas.throwFeatMissing("st", "edu.cmu.yiranf.hw1.Type.GeneType");
  ...
  public int getEd(int addr) {
      ...
      jcas.throwFeatMissing("ed", "edu.cmu.yiranf.hw1.Type.GeneType");
