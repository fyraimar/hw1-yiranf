...
public class Sentence_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.yiranf.hw1.Type.Sentence");
  ...
  public String getSentenceId(int addr) {
      ...
      jcas.throwFeatMissing("sentenceId", "edu.cmu.yiranf.hw1.Type.Sentence");
  ...
  public String getSentence(int addr) {
      ...
      jcas.throwFeatMissing("sentence", "edu.cmu.yiranf.hw1.Type.Sentence");
